...
def main():
    ...
    evidence = {}
    with TemporaryDirectory(prefix='role-status-quality-', ignore_cleanup_errors=True) as directory:
        ...
        for number, code in [(3, 'RADAR_3_INSTITUTIONS'), (4, 'RADAR_4_POLICIES')]:
            ...
            Path('audit-output/role-status-quality.json').write_text(json.dumps(evidence, indent=2, ensure_ascii=True,default=str))
